...
Preparing the dataset for time-based aggregation and modeling
...
Root Mean Squared Error (RMSE) used for comparison
Linear Regression demonstrated the best performance among baseline models by capturing long-term trends effectively
...
Clear visualization combining historical and forecasted sales
